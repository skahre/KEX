...
export function B4(props){
    ...
    return (
        <div>
            ...
            klimat. Pengarna går till en stor knippe åtgärder. Nu ska det bli lättare för äldre att motionera och göra utflykter i Älvsjöskogen. Vilobänkar ska placeras längs 
            motionsspåren, <button className="word-btn" onClick={wordFoundACB}> liksom</button> handledare att gripa tag i. Dessutom ska skyltar sättas upp, som tydligt ska visa sträckning och längd på motionsspåren. Säkert kan även yngre få nytta av dessa investeringar 
