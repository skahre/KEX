...
export function A4(props){
    ...
    return (
        <div>
            ...
            100 kilos-stenbumlingar av cement och järn ligger i ett hörn under de gummihyllor de ska lyftas upp på. Så kallade "Farmer's-väskor" (avlånga föremål med stång och pinne som 
            man förser med <button className="word-btn" onClick={wordFoundACB}>vikter</button>), däck, ok och "stockar" syns i de andra hörnen. Som 20-åring köpte Cim gymkort. Han ville komma i form, att det skulle sluta i strongman-världen hade 
            ...
            på mattan. Cim böjer knäna, greppar tak i båda handtagen och reser sig upp. Blicken blir intensiv, han tittar 
